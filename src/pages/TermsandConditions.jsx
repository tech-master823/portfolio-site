...
const TermsandConditions = ({firebaseData}) => {
  ...
  return (
    ...
    <Helmet>
    {/* Title */}
    <title>Terms & Conditions | Kauai Martins Santana Portfolio</title>

    {/* Meta Tags */}
    <meta charset="utf-8" />
    <meta name="author" content="Kauai Martins Santana" />
    <meta name="description" content="Read the Terms & Conditions for using Kauai Martins Santana's portfolio website and understand the guidelines around intellectual property, website use, and content ownership." />
    <meta name="keywords" content="Terms & Conditions, Kauai Martins Santana, Portfolio, Website Policy, Intellectual Property, Use of Website, BE REAL" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="theme-color" content="#000000" />

    {/* Open Graph Data */}
    <meta property="og:title" content="Terms & Conditions | Kauai Martins Santana Portfolio" />
    ...
    <meta property="og:description" content="Read the Terms & Conditions for using Kauai Martins Santana's portfolio website." />

    {/* Twitter Card Data */}
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Terms & Conditions | Kauai Martins Santana Portfolio" />
    <meta name="twitter:description" content="Read the Terms & Conditions for using Kauai Martins Santana's portfolio website." />
  </Helmet>
    <ThemeProvider theme={darkTheme}>
      <Body>
        ...
        <TermsContainer>
          ...
          <p>
            All content on this website, including text, images, graphics, and code, is the intellectual property of <BoldText>Kauai Martins Santana</BoldText> unless otherwise stated. Unauthorized use, reproduction, or distribution of this material is prohibited without explicit permission.
          </p>
          ...
          <p>
            The content provided on this website is for informational purposes only. While every effort is made to ensure accuracy, <BoldText>Kauai Martins Santana</BoldText> makes no guarantees or warranties of any kind regarding the completeness, reliability, or suitability of the information on the site.
          </p>

          <h2>6. External Links</h2>
          <p>
            This website may contain links to external websites. <BoldText>Kauai Martins Santana</BoldText> is not responsible for the content or practices of any linked websites and does not endorse the content of these external sites.
          </p>
